      ...
      plants: [
        {
          ...
          description: 'The oregano plants contains compounds that deter insects.',
          cost: '$10',
        },
        {
          name: 'Marigold',
    ...
    },
    {
      ...
      plants: [
        ...
        },
        {
          ...
          description: 'Requires minimal care and adds color to spaces.',
          cost: '$22',
        },
      ],
    },
          ...
          <div style={{ position: 'relative', width: '68px', height: '68px' }}>
            <a href="#" onClick={handleCartClick} style={{ textDecoration: 'none' }}>
              <svg
                ...
                height="68"
                width="68"
                style={{ fill: 'none', stroke: '#faf9f9', strokeWidth: '2' }}
              >
